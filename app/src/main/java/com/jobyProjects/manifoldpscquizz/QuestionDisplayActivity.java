...
// Udaip
    ...
    void displayQuestionFunction(Question firstQ){
        ...
        MathView mathViewTemp = findViewById(R.id.mathViewDispTemp);
       ...
       // rBa.setChecked(false);rBb.setChecked(false);rBc.setChecked(false);rBd.setChecked(false);
        ...
        mathViewTemp.setText("\\( \\color{blue}  {Answer} \\, :\\, \\)"+ firstQ.answer);
        ...
        textViewBelongs.setText(firstQ.Belongs.get(1).toString());
    ...
    void loadModuleAndDisplay( String testPath ){
        MathView mathViewTemp = findViewById(R.id.mathViewDispTemp);
       // mathViewTemp.setVisibility(View.VISIBLE);
        if (mathViewTemp.getVisibility()==View.VISIBLE){
            ...
            ref.addValueEventListener(new ValueEventListener(){
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    MathView mathViewTemp = findViewById(R.id.mathViewDispTemp);
                    mathViewTemp.setVisibility(View.INVISIBLE);

                    Button buttonFinished = findViewById(R.id.buttonFinish);
